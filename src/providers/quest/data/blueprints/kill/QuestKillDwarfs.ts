...
export const questKillDwarfs = {
  ...
  description:
    "Ragnok Hornbreaker, a formidable minotaur with a lineage as ancient as the mountains, seeks a brave soul to temper the darkness spreading from Ironforge. Corrupted by greed, 15 dwarves have strayed far from their honorable forge and kinship, becoming threats to all. Ragnok entrusts you to restore the balance: defeat these fallen dwarves and prove that honor can prevail over greed. Return victorious, and be rewarded with a piece of history, a relic embodying the strength and honor of the minotaur lineage.",
