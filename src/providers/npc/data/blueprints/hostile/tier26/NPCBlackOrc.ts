...
export const npcBlackOrc: INPCTierBlueprint<26> = {
  ...
  entityEffects: [EntityEffectBlueprint.Bleeding, EntityEffectBlueprint.Corruption, EntityEffectBlueprint.Poison],
  areaSpells: [
    {
