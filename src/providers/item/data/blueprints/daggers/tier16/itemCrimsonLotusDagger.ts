...
export const itemCrimsonLotusDagger: IEquippableMeleeTier16WeaponBlueprint = {
  key: DaggersBlueprint.CrimsonLotusDagger,
  type: ItemType.Weapon,
  subType: ItemSubType.Dagger,
  textureAtlas: "items",
  texturePath: "daggers/crimson-lotus-dagger.png",
  name: "Crimson Lotus Dagger",
  description: "A dagger imbued with the essence of a crimson lotus, exuding both beauty and lethality.",
  weight: 1.5,
