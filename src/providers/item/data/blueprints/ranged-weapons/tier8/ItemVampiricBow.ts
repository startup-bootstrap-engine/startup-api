...
export const itemVampiricBow: IEquippableRangedTier8WeaponBlueprint = {
  key: RangedWeaponsBlueprint.VampiricBow,
  type: ItemType.Weapon,
  rangeType: EntityAttackType.Ranged,
  subType: ItemSubType.Ranged,
  textureAtlas: "items",
  texturePath: "ranged-weapons/vampiric-bow.png",
  name: "Vampiric Bow",
  description: "This bow absorbs a portion of the life force from its targets, replenishing the user's health.",
  attack: 67,
  weight: 1.5,
