...
export const itemGaleWingBow: IEquippableRangedTier8WeaponBlueprint = {
  key: RangedWeaponsBlueprint.GaleWingBow,
  type: ItemType.Weapon,
  rangeType: EntityAttackType.Ranged,
  subType: ItemSubType.Ranged,
  textureAtlas: "items",
  texturePath: "ranged-weapons/gale-wing-bow.png",
  name: "Gale Wing Bow",
  description: "Inspired by the gales of the wind, this bow delivers swift and powerful shots.",
  attack: 68,
  weight: 1.3,
