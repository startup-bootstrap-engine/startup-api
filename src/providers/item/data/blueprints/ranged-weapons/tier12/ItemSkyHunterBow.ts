...
export const itemSkyHunterBow: IEquippableRangedTier12WeaponBlueprint = {
  key: RangedWeaponsBlueprint.SkyHunterBow,
  type: ItemType.Weapon,
  rangeType: EntityAttackType.Ranged,
  subType: ItemSubType.Ranged,
  textureAtlas: "items",
  texturePath: "ranged-weapons/sky-hunter-bow.png",
  name: "Sky Hunter Bow",
  description: "Forged for those who hunt among the clouds, this bow excels at hitting targets from extreme distances.",
  attack: 98,
  weight: 1.4,
