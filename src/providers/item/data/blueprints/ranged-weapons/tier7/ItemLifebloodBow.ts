...
export const itemLifebloodBow: IEquippableRangedTier7WeaponBlueprint = {
  key: RangedWeaponsBlueprint.LifebloodBow,
  type: ItemType.Weapon,
  rangeType: EntityAttackType.Ranged,
  subType: ItemSubType.Ranged,
  textureAtlas: "items",
  texturePath: "ranged-weapons/lifeblood-bow.png",
  name: "Lifeblood Bow",
  description: "A dark and powerful bow that drains the life force from enemies to heal its wielder.",
  attack: 62,
  weight: 1.5,
