...
export const itemWindriderBow: IEquippableRangedTier9WeaponBlueprint = {
  key: RangedWeaponsBlueprint.WindriderBow,
  type: ItemType.Weapon,
  rangeType: EntityAttackType.Ranged,
  subType: ItemSubType.Ranged,
  textureAtlas: "items",
  texturePath: "ranged-weapons/windrider-bow.png",
  name: "Windrider Bow",
  description:
    "This bow channels the power of the wind, allowing its user to strike swiftly and accurately from great distances.",
  attack: 77,
  weight: 1.3,
