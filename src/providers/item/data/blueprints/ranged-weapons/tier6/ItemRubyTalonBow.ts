...
export const itemRubyTalonBow: IEquippableRangedTier6WeaponBlueprint = {
  key: RangedWeaponsBlueprint.RubyTalonBow,
  type: ItemType.Weapon,
  rangeType: EntityAttackType.Ranged,
  subType: ItemSubType.Ranged,
  textureAtlas: "items",
  texturePath: "ranged-weapons/ruby-talon-bow.png",
  name: "Ruby Talon Bow",
  description: "Inlaid with rubies, this bow harnesses fiery energy to scorch enemies.",
  attack: 54,
  weight: 1.8,
