...
export const itemWatermelonSeed: IUseWithItemBlueprint = {
  ...
  description: "A small seed that grows into a watermelon. It requires fertile soil and enough water to grow.",
  weight: 0.01,
  hasUseWith: true,
  basePrice: 50 * FARMING_SEED_PRICE_RATIO,
  ...
  usableEffectDescription: "Use it on a fertile soil to plant a watermelon",
};
