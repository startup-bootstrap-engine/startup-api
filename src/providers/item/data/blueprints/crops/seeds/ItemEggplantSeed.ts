...
export const itemEggplantSeed: IUseWithItemBlueprint = {
  ...
  name: "Eggplant Seed",
  description: "A small seed that grows into an eggplant. It requires fertile soil and enough water to grow.",
  weight: 0.01,
  hasUseWith: true,
  basePrice: 40 * FARMING_SEED_PRICE_RATIO,
  ...
  usableEffectDescription: "Use it on a fertile soil to plant an eggplant",
};
