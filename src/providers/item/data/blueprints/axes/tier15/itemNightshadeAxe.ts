...
export const itemNightshadeAxe: IEquippableMeleeTier15WeaponBlueprint = {
  key: AxesBlueprint.NightshadeAxe,
  type: ItemType.Weapon,
  subType: ItemSubType.Axe,
  textureAtlas: "items",
  texturePath: "axes/nightshade-axe.png",
  name: "Nightshade Axe",
  description: "An eerie axe infused with poisonous energy.",
  weight: 4.6,
