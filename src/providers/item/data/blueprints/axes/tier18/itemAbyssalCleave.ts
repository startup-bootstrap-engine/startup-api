...
export const itemAbyssalCleave: IEquippableMeleeTier18WeaponBlueprint = {
  key: AxesBlueprint.AbyssalCleave,
  type: ItemType.Weapon,
  subType: ItemSubType.Axe,
  textureAtlas: "items",
  texturePath: "axes/abyssal-cleave.png",
  name: "Abyssal Cleave",
  description: "A dark axe that rends the souls of those it strikes.",
  weight: 4.9,
