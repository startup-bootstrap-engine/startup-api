...
export enum RangedWeaponsBlueprint {
  ...
  FalconFeatherBow = "falcon-feather-bow",
  FalconWingBow = "falcon-wing-bow",
  SkyHunterBow = "sky-hunter-bow",
  AerialStrikeBow = "aerial-strike-bow",
  WindriderBow = "windrider-bow",
  FalconEyeBow = "falcon-eye-bow",
  TalonStrikeBow = "talon-strike-bow",
  HorizonPiercerBow = "horizon-piercer-bow",
  GaleWingBow = "gale-wing-bow",
  BloodMoonBow = "blood-moon-bow",
  VampiricBow = "vampiric-bow",
  CrimsonFangBow = "crimson-fang-bow",
  SanguineShadeBow = "sanguine-shade-bow",
  LifebloodBow = "lifeblood-bow",
  BloodthirstBow = "bloodthirst-bow",
  NightshadeBow = "nightshade-bow",
  DarkVeinBow = "dark-vein-bow",
  RubyTalonBow = "ruby-talon-bow",
}
