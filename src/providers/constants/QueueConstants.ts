...
export const QUEUE_NPC_DEFAULT_SCALE_FACTOR = 1;
export const QUEUE_CHARACTER_DEFAULT_SCALE_FACTOR = 2;
...
export const QUEUE_WORKER_MAX_CONCURRENCY = PROMISE_DEFAULT_CONCURRENCY; // Max concurrency the system can handle
export const QUEUE_WORKER_CONCURRENCY_SCALING_FACTOR = 1;

export const QUEUE_WORKER_JOB_RATE_SCALING_FACTOR = 1;
export const QUEUE_WORKER_MIN_JOB_RATE = (PROMISE_DEFAULT_CONCURRENCY * 100) / PROMISE_DEFAULT_CONCURRENCY;
export const QUEUE_WORKER_MAX_JOB_RATE = PROMISE_DEFAULT_CONCURRENCY * 100;
