...
export const TRADING_PRICE_CONTROL_RATIO_SENSITIVITY = 0.005; // The sensitivity of the price adjustment ratio. The higher the value, the more sensitive the price adjustment will be to the amount of items bought or sold
