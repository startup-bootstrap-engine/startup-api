...
export const TRADING_PRICE_CONTROL_TRADING_HISTORY_MAX_DAYS = 3; // Max days to keep trading history of items purchased, so we can adjust prices based on demand
...
export const TRADING_PRICE_CONTROL_RATIO_SENSITIVITY = 0.0025; // The sensitivity of the price adjustment ratio. The higher the value, the more sensitive the price adjustment will be to the amount of items bought or sold
