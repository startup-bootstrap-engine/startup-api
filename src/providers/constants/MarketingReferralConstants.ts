...
export const CRAFTING_SOCIAL_CRYSTAL_REQUIREMENT_RATIO = 1.85; // higher than 1 means more social crystals required to craft items
...
export const CRAFTING_SOCIAL_CRYSTAL_DAILY_REWARD_CHANCE = 25; // chance to get social crystals as daily reward, in %
